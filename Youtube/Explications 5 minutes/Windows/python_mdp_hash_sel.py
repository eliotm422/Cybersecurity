...
def cracker_mdp_lettre_par_lettre(password, salt, dictionnaire_test):
    # Nouveau mdp
    new_password = ''
...
def main():
    ...
    nb_tentative1, new_password1, temps_execution1 = cracker_mdp_lettre_par_lettre(password1, salt1, dictionnaire_test)
    affichage_cracker_mdp(nb_tentative1, new_password1, temps_execution1)

    hash_nb_tentative1, hash_new_password1, hash_temps_execution1 = cracker_mdp_lettre_par_lettre(hashed_password1, b'', dictionnaire_test)
